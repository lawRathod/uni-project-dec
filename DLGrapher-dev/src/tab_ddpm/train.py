...
# import zero
from tab_ddpm.gaussian_multinomial_diffusion import \
    GaussianMultinomialDiffusion
from tab_ddpm.utils_train import (get_model, make_dataset_from_memory,
                                  update_ema)
...
def train(
    ...
    dataset = make_dataset_from_memory(
        X_cat, X_num, y, info,
        T,
        num_classes=model_params['num_classes'],
        is_y_cond=model_params['is_y_cond'],
    ...
    return diffusion._denoise_fn, trainer.ema_model
