...
for which_run in range(1, num_of_runs):
    ...
    DEFAULT_EPOCHS = 31             # Back to original - worked better
        ...
        def __init__(self, dataset):
            ...
            if model_type == "GCN":
                ...
                if data_type.startswith("Custom_"):
                    # Larger model with no dropout to encourage overfitting for better MIA signal
                    self.conv1 = GCNConv(dataset.num_node_features, 128)
                    self.conv2 = GCNConv(128, 64)
                    self.conv3 = GCNConv(64, dataset.num_classes)
                    self.dropout = 0.0  # No dropout = more overfitting
                else:
